...
export default function Stub() {
  return (
    <div className="main_wrapper">
      ...
      {/* Текст о том, что сайт в разработке */}
      <p style={{ textAlign: "center", marginTop: "2rem", fontWeight: "bold" }}>
        Разработчик нового портала аварийных отключений «МосОблЭнерго» трудится
        в поте лица, чтобы вы скорее могли потыкать все кнопочки и пощупать
        функционал нашего нового сайта!
      </p>
