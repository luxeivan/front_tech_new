...
import styles from "./PortalAnime.module.css";

// Те же массивы/переменные, что и в вашем Anime.js
const arr = [
...
export default function PortalAnime() {
  // Чтобы подхватить цвета antd
  const { colorPrimary } = theme.useToken().token;

  return (
    <div className={styles.container}>
      {/* SVG с анимированными path */}
      <motion.svg
      ...
      >
        ...
        >
          Портал технологических нарушений
        </Typography.Title>
      </motion.div>
    </div>
  );
